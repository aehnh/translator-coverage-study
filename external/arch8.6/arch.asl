        ...
        if el == EL3 then
            ...
            if inputaddr[top] == '0' then
                ...
                if inputsize < inputsize_min then
                    ...
                    if c == Constraint_FORCE then inputsize = inputsize_min;
                basefound = inputsize >= inputsize_min && inputsize <= inputsize_max && IsZero(inputaddr[top:inputsize]);
                disabled = TCR_EL2.EPD0 == '1' || (el == EL0 && HaveE0PDExt() && TCR_EL2.E0PD0 == '1');
                disabled = disabled || (el == EL0 && acctype == AccType_NONFAULT && TCR_EL2.NFD0 == '1');
                ...
                disabled = TCR_EL2.EPD1 == '1' || (el == EL0 && HaveE0PDExt() && TCR_EL2.E0PD1 == '1');
                disabled = disabled || (el == EL0 && acctype == AccType_NONFAULT && TCR_EL2.NFD1 == '1');
            ...
            if inputaddr[top] == '0' then
                ...
                if inputsize < inputsize_min then
                    ...
                    if c == Constraint_FORCE then inputsize = inputsize_min;
                basefound = inputsize >= inputsize_min && inputsize <= inputsize_max && IsZero(inputaddr[top:inputsize]);
                disabled = TCR_EL1.EPD0 == '1' || (el == EL0 && HaveE0PDExt() && TCR_EL1.E0PD0 == '1');
                ...
                if inputsize < inputsize_min then
                    ...
                    if c == Constraint_FORCE then inputsize = inputsize_min;
                basefound = inputsize >= inputsize_min && inputsize <= inputsize_max && IsOnes(inputaddr[top:inputsize]);
                disabled = TCR_EL1.EPD1 == '1' || (el == EL0 && HaveE0PDExt() && TCR_EL1.E0PD1 == '1');
