            ...
            case (28 +: 4, 27 +: 1, 26 +: 1, 25 +: 1, 23 +: 2, 22 +: 1, 16 +: 6, 12 +: 4, 10 +: 2, 0 +: 10) of
                ...
                when ('xx11', _, _, _, '0x', _, '1xxxxx', _, '00', _) => // memop
                    ...
                    case (size, V, A, R, o3, opc) of
                        ...
                        when (_, '0', '0', '1', '1', '001') => __UNALLOCATED
                        when (_, '0', '0', '1', '1', '010') => __UNALLOCATED
                        when (_, '0', '0', '1', '1', '011') => __UNALLOCATED
                        when (_, '0', '0', '1', '1', '101') => __UNALLOCATED
                        when (_, '0', '1', '0', '1', '001') => __UNALLOCATED
                        when (_, '0', '1', '0', '1', '010') => __UNALLOCATED
                        when (_, '0', '1', '0', '1', '011') => __UNALLOCATED
                        when (_, '0', '1', '0', '1', '101') => __UNALLOCATED
                        when (_, '0', '1', '1', '1', '001') => __UNALLOCATED
                        when (_, '0', '1', '1', '1', '010') => __UNALLOCATED
                        when (_, '0', '1', '1', '1', '011') => __UNALLOCATED
                        when (_, '0', '1', '1', '1', '100') => __UNALLOCATED
                        when (_, '0', '1', '1', '1', '101') => __UNALLOCATED
                        ...
                        when ('00', '0', '0', '0', '1', '001') => __UNALLOCATED
                        when ('00', '0', '0', '0', '1', '010') => __UNALLOCATED
                        when ('00', '0', '0', '0', '1', '011') => __UNALLOCATED
                        when ('00', '0', '0', '0', '1', '101') => __UNALLOCATED
                        ...
                        when ('01', '0', '0', '0', '1', '001') => __UNALLOCATED
                        when ('01', '0', '0', '0', '1', '010') => __UNALLOCATED
                        when ('01', '0', '0', '0', '1', '011') => __UNALLOCATED
                        when ('01', '0', '0', '0', '1', '101') => __UNALLOCATED
                        ...
                        when ('10', '0', '0', '0', '1', '001') => __UNALLOCATED
                        when ('10', '0', '0', '0', '1', '010') => __UNALLOCATED
                        when ('10', '0', '0', '0', '1', '011') => __UNALLOCATED
                        when ('10', '0', '0', '0', '1', '101') => __UNALLOCATED
    ...
    case (29 +: 3, 27 +: 2, 0 +: 27) of
        ...
        when ('111', !'00', _) =>
            ...
            case (29 +: 3, 25 +: 4, 20 +: 5, 16 +: 4, 15 +: 1, 0 +: 15) of
                when (_, 'x11x', _, _, _, _) =>
                    // cpaf
                    case (29 +: 3, 28 +: 1, 26 +: 2, 24 +: 2, 12 +: 12, 11 +: 1, 5 +: 6, 4 +: 1, 0 +: 4) of
                        when (_, _, _, '0x', _, '0', _, _, _) => __UNPREDICTABLE
                        when (_, _, _, '10', _, '0', _, _, _) => __UNPREDICTABLE
                        ...
                        when (_, _, _, !'11', _, '1', _, _, _) =>
                            // advsimdext
                            case (26 +: 6, 23 +: 3, 22 +: 1, 16 +: 6, 12 +: 4, 11 +: 1, 10 +: 1, 8 +: 2, 7 +: 1, 6 +: 1, 5 +: 1, 4 +: 1, 0 +: 4) of
                                when (_, '0xx', _, _, _, _, _, '0x', _, _, _, _, _) => // simd_3sameext
                                    __field op1 23 +: 2
                                    __field D 22 +: 1
                                    __field op2 20 +: 2
                                    __field Vn 16 +: 4
                                ...
                                when (_, '100', _, _, _, _, '0', !'00', _, '0', _, '0', _) => // fp_csel
                                    __field D 22 +: 1
                                    __field cc 20 +: 2
                                    __field Vn 16 +: 4
                                    __field Vd 12 +: 4
                                    ...
                                    __field Vm 0 +: 4
                                    case () of
                                        when () => __encoding aarch32_VSEL_T1_A // VSELGT_T1_D
                                when (_, '101', _, '00xxxx', _, _, '0', !'00', _, _, _, '0', _) => // fp_minmax
                                    __field D 22 +: 1
                                    __field Vn 16 +: 4
                                    __field Vd 12 +: 4
                                    __field size 8 +: 2
                                    ...
                                    __field Vm 0 +: 4
                                    case (op) of
                                        when ('0') => __encoding aarch32_VMAXNM_T2_A // VMAXNM_T2_D
                                        when ('1') => __encoding aarch32_VMAXNM_T2_A // VMINNM_T2_D
                                when (_, '101', _, '110000', _, _, '0', !'00', _, '1', _, '0', _) => // fp_extins
                                    __field D 22 +: 1
                                    __field Vd 12 +: 4
                                    __field size 8 +: 2
                                    __field op 7 +: 1
                                    ...
                                    case (size, op) of
                                        ...
                                        when ('11', _) => __UNALLOCATED
                                when (_, '101', _, '111xxx', _, _, '0', !'00', _, '1', _, '0', _) => // fp_toint
                                    __field D 22 +: 1
                                    __field o1 18 +: 1
                                    __field RM 16 +: 2
                                    __field Vd 12 +: 4
                                    ...
                                    __field Vm 0 +: 4
                                    case (o1, RM) of
                                        when ('0', '00') => __encoding aarch32_VRINTA_vfp_T1_A // VRINTA_vfp_T1_D
                                        when ('0', '01') => __encoding aarch32_VRINTA_vfp_T1_A // VRINTN_vfp_T1_D
                                        when ('0', '10') => __encoding aarch32_VRINTA_vfp_T1_A // VRINTP_vfp_T1_D
                                        when ('0', '11') => __encoding aarch32_VRINTA_vfp_T1_A // VRINTM_vfp_T1_D
                                        when ('1', '00') => __encoding aarch32_VCVTA_vfp_T1_A // VCVTA_vfp_T1_D
                                        when ('1', '01') => __encoding aarch32_VCVTA_vfp_T1_A // VCVTN_vfp_T1_D
                                        when ('1', '10') => __encoding aarch32_VCVTA_vfp_T1_A // VCVTP_vfp_T1_D
                                        when ('1', '11') => __encoding aarch32_VCVTA_vfp_T1_A // VCVTM_vfp_T1_D
                                when (_, '10x', _, _, _, _, '0', '00', _, _, _, _, _) => // tfloatdpmac
                                    __field op1 23 +: 1
                                    __field D 22 +: 1
                                    __field op2 20 +: 2
                                    __field Vn 16 +: 4
                                    ...
                                    __field Vm 0 +: 4
                                    case (op1, op2, Q, U) of
                                        when ('0', _, _, '0') => __encoding aarch32_VCMLA_idx_T1_A // VCMLA_s_T1_QH
                                        when ('0', '00', _, '1') => __encoding aarch32_VFMAL_i_T1_A // VFMAL_s_T1_Q
                                        when ('0', '01', _, '1') => __encoding aarch32_VFMAL_i_T1_A // VFMSL_s_T1_Q
                                        when ('0', '10', _, '1') => __UNALLOCATED
                                        when ('0', '11', _, '1') => __encoding aarch32_VFMA_bfs_T1_A // VFMA_bfs_T1_Q
                                        when ('1', _, '0', '0') => __encoding aarch32_VCMLA_idx_T1_A // VCMLA_s_T1_DS
                                        when ('1', _, _, '1') => __UNALLOCATED
                                        when ('1', _, '1', '0') => __encoding aarch32_VCMLA_idx_T1_A // VCMLA_s_T1_QS
                                when (_, '10x', _, _, _, _, '1', '0x', _, _, _, _, _) => // tsimd_dotprod
                                    __field op1 23 +: 1
                                    __field D 22 +: 1
                                    __field op2 20 +: 2
                                    __field Vn 16 +: 4
                                    ...
                                    __field U 4 +: 1
                                    __field Vm 0 +: 4
                                    case (op1, op2, op4, Q, U) of
                                        when ('0', '00', '0', _, _) => __UNALLOCATED
                                        when ('0', '00', '1', '0', '0') => __encoding aarch32_VDOT_bf16_i_T1_A // VDOT_s_T1_D
                                        when ('0', '00', '1', _, '1') => __UNALLOCATED
                                        when ('0', '00', '1', '1', '0') => __encoding aarch32_VDOT_bf16_i_T1_A // VDOT_s_T1_Q
                                        when ('0', '01', '0', _, _) => __UNALLOCATED
                                        when ('0', '10', '0', _, _) => __UNALLOCATED
                                        when ('0', '10', '1', '0', '0') => __encoding aarch32_VDOT_s_T1_A // VSDOT_s_T1_D
                                        when ('0', '10', '1', '0', '1') => __encoding aarch32_VDOT_s_T1_A // VUDOT_s_T1_D
                                        when ('0', '10', '1', '1', '0') => __encoding aarch32_VDOT_s_T1_A // VSDOT_s_T1_Q
                                        when ('0', '10', '1', '1', '1') => __encoding aarch32_VDOT_s_T1_A // VUDOT_s_T1_Q
                                        when ('0', '11', _, _, _) => __UNALLOCATED
                                        when ('1', _, '0', _, _) => __UNALLOCATED
                                        when ('1', '00', '1', '0', '0') => __encoding aarch32_DOT_T1_A // VUSDOT_s_T1_D
                                        when ('1', '00', '1', '0', '1') => __encoding aarch32_DOT_T1_A // VSUDOT_s_T1_D
                                        when ('1', '00', '1', '1', '0') => __encoding aarch32_DOT_T1_A // VUSDOT_s_T1_Q
                                        when ('1', '00', '1', '1', '1') => __encoding aarch32_DOT_T1_A // VSUDOT_s_T1_Q
                                        when ('1', '01', '1', _, _) => __UNALLOCATED
                                        when ('1', '1x', '1', _, _) => __UNALLOCATED
                        when (_, '0', _, '0x', _, '1', _, _, _) =>
                            // sysldst_mov64
                            case (25 +: 7, 21 +: 4, 12 +: 9, 11 +: 1, 9 +: 2, 0 +: 9) of
                                when (_, '00x0', _, _, '0x', _) => // simdfp_mov64
                                    __field D 22 +: 1
                                    __field op 20 +: 1
                                    __field Rt2 16 +: 4
                                    __field Rt 12 +: 4
                                ...
                                when (_, '00x0', _, _, '11', _) => // cp_mov64
                                    ...
                                    case (D, L) of
                                        when ('0', _) => __UNALLOCATED
                                        when ('1', '0') => __encoding aarch32_MCRR_T1A1_A // MCRR_T1
                                        when ('1', '1') => __encoding aarch32_MRRC_T1A1_A // MRRC_T1
                                when (_, !'00x0', _, _, '0x', _) => // simdfp_ldst
                                    __field P 24 +: 1
                                    __field U 23 +: 1
                                    __field D 22 +: 1
                                    __field W 21 +: 1
                                ...
                                when (_, !'00x0', _, _, '11', _) => // cp_ldst
                                    ...
                                    __field cp15 8 +: 1
                                    __field imm8 0 +: 8
                                    case (P:U:W, D, L, Rn, CRd, cp15) of
                                        when (!'000', _, _, _, !'0101', '0') => __UNALLOCATED
                                        when (!'000', '0', '1', '1111', '0101', '0') => __encoding aarch32_LDC_l_T1A1_A // LDC_l_T1
                                        when (!'000', _, _, _, _, '1') => __UNALLOCATED
                                        when (!'000', '1', _, _, '0101', '0') => __UNALLOCATED
                                        when ('0x1', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_T1_post
                                        when ('0x1', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_T1_post
                                        when ('010', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_T1_unind
                                        when ('010', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_T1_unind
                                        when ('1x0', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_T1_off
                                        when ('1x0', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_T1_off
                                        when ('1x1', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_T1_pre
                                        when ('1x1', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_T1_pre
                                when (_, _, _, _, '10', _) => __UNPREDICTABLE
                        when (_, '0', _, '10', _, '1', _, '0', _) =>
                            // fpdp
                            case (24 +: 8, 20 +: 4, 12 +: 8, 10 +: 2, 7 +: 3, 6 +: 1, 5 +: 1, 4 +: 1, 0 +: 4) of
                                when (_, '1x11', _, _, _, '1', _, _, _) => // fp_2r
                                    __field D 22 +: 1
                                    __field o1 19 +: 1
                                    __field opc2 16 +: 3
                                    __field Vd 12 +: 4
                                ...
                                when (_, '1x11', _, _, _, '0', _, _, _) => // fp_movi
                                    __field D 22 +: 1
                                    __field imm4H 16 +: 4
                                    __field Vd 12 +: 4
                                    __field size 8 +: 2
                                ...
                                when (_, !'1x11', _, _, _, _, _, _, _) => // fp_3r
                                    __field o0 23 +: 1
                                    __field D 22 +: 1
                                    __field o1 20 +: 2
                                    __field Vn 16 +: 4
                        ...
                        when (_, '0', _, '10', _, '1', _, '1', _) =>
                            // sys_mov32
                            case (24 +: 8, 21 +: 3, 12 +: 9, 11 +: 1, 8 +: 3, 5 +: 3, 4 +: 1, 0 +: 4) of
                                when (_, '000', _, _, '000', _, _, _) => __UNPREDICTABLE
                                when (_, '000', _, _, '001', _, _, _) => // fp_mov16
                                    __field op 20 +: 1
                                    __field Vn 16 +: 4
                                    __field Rt 12 +: 4
                                    __field N 7 +: 1
                                    case () of
                                        when () => __encoding aarch32_VMOV_h_T1_A // VMOV_h_T1
                                when (_, '000', _, _, '010', _, _, _) => // fp_mov32
                                    __field op 20 +: 1
                                    __field Vn 16 +: 4
                                    __field Rt 12 +: 4
                                    __field N 7 +: 1
                                ...
                                when (_, '001', _, _, '010', _, _, _) => __UNPREDICTABLE
                                when (_, '01x', _, _, '010', _, _, _) => __UNPREDICTABLE
                                when (_, '10x', _, _, '010', _, _, _) => __UNPREDICTABLE
                                when (_, '110', _, _, '010', _, _, _) => __UNPREDICTABLE
                                when (_, '111', _, _, '010', _, _, _) => // fp_msr
                                    __field L 20 +: 1
                                    __field reg 16 +: 4
                                    __field Rt 12 +: 4
                                    case (L) of
                                ...
                                when (_, _, _, _, '011', _, _, _) => // simd_dup_el
                                    __field opc1 21 +: 3
                                    __field L 20 +: 1
                                    __field Vn 16 +: 4
                                    __field Rt 12 +: 4
                                ...
                                when (_, _, _, _, '11x', _, _, _) => // cp_mov32
                                    __field opc1 21 +: 3
                                    __field L 20 +: 1
                                    __field CRn 16 +: 4
                                    __field Rt 12 +: 4
                                    ...
                                    __field CRm 0 +: 4
                                    case (L) of
                                        when ('0') => __encoding aarch32_MCR_T1A1_A // MCR_T1
                                        when ('1') => __encoding aarch32_MRC_T1A1_A // MRC_T1
...
__decode A32
    ...
    case (28 +: 4, 25 +: 3, 5 +: 20, 4 +: 1, 0 +: 4) of
        ...
        when (_, '11x', _, _, _) =>
            // cops_as
            case (28 +: 4, 26 +: 2, 24 +: 2, 12 +: 12, 11 +: 1, 5 +: 6, 4 +: 1, 0 +: 4) of
                when (_, _, '0x', _, '0', _, _, _) => __UNPREDICTABLE
                when (_, _, '10', _, '0', _, _, _) => __UNPREDICTABLE
                ...
                when ('1111', _, !'11', _, '1', _, _, _) =>
                    // advsimdext
                    case (26 +: 6, 23 +: 3, 22 +: 1, 16 +: 6, 12 +: 4, 11 +: 1, 10 +: 1, 8 +: 2, 7 +: 1, 6 +: 1, 5 +: 1, 4 +: 1, 0 +: 4) of
                        when (_, '0xx', _, _, _, _, _, '0x', _, _, _, _, _) => // simd3reg_sameext
                            __field op1 23 +: 2
                            __field D 22 +: 1
                            __field op2 20 +: 2
                            __field Vn 16 +: 4
                            ...
                            case (op1, op2, op3, op4, Q, U) of
                                ...
                                when ('10', '11', _, _, _, _) => __UNALLOCATED
                                when ('11', '11', _, _, _, _) => __UNALLOCATED
                        when (_, '100', _, _, _, _, '0', !'00', _, '0', _, '0', _) => // fpcsel
                            __field D 22 +: 1
                            __field cc 20 +: 2
                            __field Vn 16 +: 4
                            __field Vd 12 +: 4
                            ...
                            __field Vm 0 +: 4
                            case () of
                                when () => __encoding aarch32_VSEL_A1_A // VSELGT_A1_D
                        when (_, '101', _, '00xxxx', _, _, '0', !'00', _, _, _, '0', _) => // fpminmaxnm
                            __field D 22 +: 1
                            __field Vn 16 +: 4
                            __field Vd 12 +: 4
                            __field size 8 +: 2
                            ...
                            __field Vm 0 +: 4
                            case (op) of
                                when ('0') => __encoding aarch32_VMAXNM_A2_A // VMAXNM_A2_D
                                when ('1') => __encoding aarch32_VMAXNM_A2_A // VMINNM_A2_D
                        when (_, '101', _, '110000', _, _, '0', !'00', _, '1', _, '0', _) => // fpextins
                            __field D 22 +: 1
                            __field Vd 12 +: 4
                            __field size 8 +: 2
                            __field op 7 +: 1
                            ...
                            case (size, op) of
                                ...
                                when ('11', _) => __UNALLOCATED
                        when (_, '101', _, '111xxx', _, _, '0', !'00', _, '1', _, '0', _) => // fpcvtrnd
                            __field D 22 +: 1
                            __field o1 18 +: 1
                            __field RM 16 +: 2
                            __field Vd 12 +: 4
                            ...
                            __field Vm 0 +: 4
                            case (o1, RM) of
                                when ('0', '00') => __encoding aarch32_VRINTA_vfp_A1_A // VRINTA_vfp_A1_D
                                when ('0', '01') => __encoding aarch32_VRINTA_vfp_A1_A // VRINTN_vfp_A1_D
                                when ('0', '10') => __encoding aarch32_VRINTA_vfp_A1_A // VRINTP_vfp_A1_D
                                when ('0', '11') => __encoding aarch32_VRINTA_vfp_A1_A // VRINTM_vfp_A1_D
                                when ('1', '00') => __encoding aarch32_VCVTA_vfp_A1_A // VCVTA_vfp_A1_D
                                when ('1', '01') => __encoding aarch32_VCVTA_vfp_A1_A // VCVTN_vfp_A1_D
                                when ('1', '10') => __encoding aarch32_VCVTA_vfp_A1_A // VCVTP_vfp_A1_D
                                when ('1', '11') => __encoding aarch32_VCVTA_vfp_A1_A // VCVTM_vfp_A1_D
                        when (_, '10x', _, _, _, _, '0', '00', _, _, _, _, _) => // floatdpmac
                            __field op1 23 +: 1
                            __field D 22 +: 1
                            __field op2 20 +: 2
                            __field Vn 16 +: 4
                            ...
                            __field Vm 0 +: 4
                            case (op1, op2, Q, U) of
                                when ('0', _, _, '0') => __encoding aarch32_VCMLA_idx_A1_A // VCMLA_s_A1_QH
                                when ('0', '00', _, '1') => __encoding aarch32_VFMAL_i_A1_A // VFMAL_s_A1_Q
                                when ('0', '01', _, '1') => __encoding aarch32_VFMAL_i_A1_A // VFMSL_s_A1_Q
                                when ('0', '10', _, '1') => __UNALLOCATED
                                when ('0', '11', _, '1') => __encoding aarch32_VFMA_bfs_A1_A // VFMA_bfs_A1_Q
                                when ('1', _, '0', '0') => __encoding aarch32_VCMLA_idx_A1_A // VCMLA_s_A1_DS
                                when ('1', _, _, '1') => __UNALLOCATED
                                when ('1', _, '1', '0') => __encoding aarch32_VCMLA_idx_A1_A // VCMLA_s_A1_QS
                        when (_, '10x', _, _, _, _, '1', '0x', _, _, _, _, _) => // simd_dotprod
                            __field op1 23 +: 1
                            __field D 22 +: 1
                            __field op2 20 +: 2
                            __field Vn 16 +: 4
                            ...
                            case (op1, op2, op4, Q, U) of
                                when ('0', '00', '0', _, _) => __UNALLOCATED
                                when ('0', '00', '1', '0', '0') => __encoding aarch32_VDOT_bf16_i_A1_A // VDOT_s_A1_D
                                when ('0', '00', '1', _, '1') => __UNALLOCATED
                                when ('0', '00', '1', '1', '0') => __encoding aarch32_VDOT_bf16_i_A1_A // VDOT_s_A1_Q
                                when ('0', '01', '0', _, _) => __UNALLOCATED
                                when ('0', '10', '0', _, _) => __UNALLOCATED
                                when ('0', '10', '1', '0', '0') => __encoding aarch32_VDOT_s_A1_A // VSDOT_s_A1_D
                                when ('0', '10', '1', '0', '1') => __encoding aarch32_VDOT_s_A1_A // VUDOT_s_A1_D
                                when ('0', '10', '1', '1', '0') => __encoding aarch32_VDOT_s_A1_A // VSDOT_s_A1_Q
                                when ('0', '10', '1', '1', '1') => __encoding aarch32_VDOT_s_A1_A // VUDOT_s_A1_Q
                                when ('0', '11', _, _, _) => __UNALLOCATED
                                when ('1', _, '0', _, _) => __UNALLOCATED
                                when ('1', '00', '1', '0', '0') => __encoding aarch32_DOT_A1_A // VUSDOT_s_A1_D
                                when ('1', '00', '1', '0', '1') => __encoding aarch32_DOT_A1_A // VSUDOT_s_A1_D
                                when ('1', '00', '1', '1', '0') => __encoding aarch32_DOT_A1_A // VUSDOT_s_A1_Q
                                when ('1', '00', '1', '1', '1') => __encoding aarch32_DOT_A1_A // VSUDOT_s_A1_Q
                                when ('1', '01', '1', _, _) => __UNALLOCATED
                                when ('1', '1x', '1', _, _) => __UNALLOCATED
                when (!'1111', _, '0x', _, '1', _, _, _) =>
                    // sysldst_mov64
                    case (28 +: 4, 25 +: 3, 21 +: 4, 12 +: 9, 11 +: 1, 9 +: 2, 0 +: 9) of
                        when (_, _, '00x0', _, _, '0x', _) => // movsimdfpgp64
                            __field cond 28 +: 4
                            __field D 22 +: 1
                            __field op 20 +: 1
                            __field Rt2 16 +: 4
                        ...
                        when (_, _, '00x0', _, _, '11', _) => // movcpgp64
                            __field cond 28 +: 4
                            __field D 22 +: 1
                            __field L 20 +: 1
                            __field Rt2 16 +: 4
                            ...
                            case (D, L) of
                                when ('0', _) => __UNALLOCATED
                                when ('1', '0') => __encoding aarch32_MCRR_T1A1_A // MCRR_A1
                                when ('1', '1') => __encoding aarch32_MRRC_T1A1_A // MRRC_A1
                        when (_, _, !'00x0', _, _, '0x', _) => // ldstsimdfp
                            __field cond 28 +: 4
                            __field P 24 +: 1
                            __field U 23 +: 1
                            __field D 22 +: 1
                        ...
                        when (_, _, !'00x0', _, _, '11', _) => // ldstcp
                            ...
                            __field imm8 0 +: 8
                            case (P:U:W, D, L, Rn, CRd, cp15) of
                                when (!'000', '0', _, _, !'0101', '0') => __UNALLOCATED
                                when (!'000', '0', '1', '1111', '0101', '0') => __encoding aarch32_LDC_l_T1A1_A // LDC_l_A1
                                when (!'000', _, _, _, _, '1') => __UNALLOCATED
                                when (!'000', '1', _, _, '0101', '0') => __UNALLOCATED
                                when ('0x1', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_A1_post
                                when ('0x1', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_A1_post
                                when ('010', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_A1_unind
                                when ('010', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_A1_unind
                                when ('1x0', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_A1_off
                                when ('1x0', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_A1_off
                                when ('1x1', '0', '0', _, '0101', '0') => __encoding aarch32_STC_T1A1_A // STC_A1_pre
                                when ('1x1', '0', '1', !'1111', '0101', '0') => __encoding aarch32_LDC_i_T1A1_A // LDC_i_A1_pre
                        when (_, _, _, _, _, '10', _) => __UNPREDICTABLE
                when (!'1111', _, '10', _, '1', _, '0', _) =>
                    // fpdp
                    case (28 +: 4, 24 +: 4, 20 +: 4, 12 +: 8, 10 +: 2, 7 +: 3, 6 +: 1, 5 +: 1, 4 +: 1, 0 +: 4) of
                        when (_, _, '1x11', _, _, _, '1', _, _, _) => // fpdp2reg
                            __field cond 28 +: 4
                            __field D 22 +: 1
                            __field o1 19 +: 1
                            __field opc2 16 +: 3
                        ...
                        when (_, _, '1x11', _, _, _, '0', _, _, _) => // fpimm
                            __field cond 28 +: 4
                            __field D 22 +: 1
                            __field imm4H 16 +: 4
                            __field Vd 12 +: 4
                        ...
                        when (_, _, !'1x11', _, _, _, _, _, _, _) => // fpdp3reg
                            __field cond 28 +: 4
                            __field o0 23 +: 1
                            __field D 22 +: 1
                            __field o1 20 +: 2
                ...
                when (!'1111', _, '10', _, '1', _, '1', _) =>
                    // sys_mov32
                    case (28 +: 4, 24 +: 4, 21 +: 3, 12 +: 9, 11 +: 1, 8 +: 3, 5 +: 3, 4 +: 1, 0 +: 4) of
                        when (_, _, '000', _, _, '000', _, _, _) => __UNPREDICTABLE
                        when (_, _, '000', _, _, '001', _, _, _) => // movfpgp16
                            __field cond 28 +: 4
                            __field op 20 +: 1
                            __field Vn 16 +: 4
                            __field Rt 12 +: 4
                        ...
                        when (_, _, '000', _, _, '010', _, _, _) => // movfpgp32
                            __field cond 28 +: 4
                            __field op 20 +: 1
                            __field Vn 16 +: 4
                            __field Rt 12 +: 4
                        ...
                        when (_, _, '001', _, _, '010', _, _, _) => __UNPREDICTABLE
                        when (_, _, '01x', _, _, '010', _, _, _) => __UNPREDICTABLE
                        when (_, _, '10x', _, _, '010', _, _, _) => __UNPREDICTABLE
                        when (_, _, '110', _, _, '010', _, _, _) => __UNPREDICTABLE
                        when (_, _, '111', _, _, '010', _, _, _) => // movfpsr
                            __field cond 28 +: 4
                            __field L 20 +: 1
                            __field reg 16 +: 4
                            __field Rt 12 +: 4
                        ...
                        when (_, _, _, _, _, '011', _, _, _) => // movsimdgp
                            __field cond 28 +: 4
                            __field opc1 21 +: 3
                            __field L 20 +: 1
                            __field Vn 16 +: 4
                            ...
                            case (opc1, L, opc2) of
                                ...
                                when ('1xx', '0', '1x') => __UNALLOCATED
                        when (_, _, _, _, _, '10x', _, _, _) => __UNPREDICTABLE
                        when (_, _, _, _, _, '11x', _, _, _) => // movcpgp32
                            __field cond 28 +: 4
                            __field opc1 21 +: 3
                            __field L 20 +: 1
                            __field CRn 16 +: 4
                            ...
                            __field CRm 0 +: 4
                            case (L) of
                                when ('0') => __encoding aarch32_MCR_T1A1_A // MCR_A1
                                when ('1') => __encoding aarch32_MRC_T1A1_A // MRC_A1
        when ('1111', '0xx', _, _, _) =>
            // uncond_as
